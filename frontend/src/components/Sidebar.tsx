    ...
    return (
        <aside className="fixed left-0 top-0 h-screen w-20 border-r border-base-300 bg-base-100 flex flex-col items-center py-6 z-50">
            <nav className="flex flex-col gap-6 flex-1 mt-4">
                <button className="btn btn-ghost btn-circle" aria-label="Inicio">
                    <Home size={26} strokeWidth={1.5} />
                </button>

                <button className="btn btn-ghost btn-circle" aria-label="Eventos">
                    <CalendarDays size={26} strokeWidth={1.5} />
                </button>

                <button className="btn btn-ghost btn-circle" aria-label="Grupos">
                    <Users size={26} strokeWidth={1.5} />
                </button>

                <button className="btn btn-ghost btn-circle" aria-label="Perfil">
                    <User size={26} strokeWidth={1.5} />
                </button>

                <button className="btn btn-ghost btn-circle" aria-label="Configuración">
